  ...
  return (
    <PageWrapper gap="lg" justify="center">
      ...
      <TopSection gap="md">
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>MarsSwap Governance</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                  Mars tokens represent voting shares in MarsSwap governance. You can vote on each proposal yourself or
              ...
              <ExternalLink
                ...
                target="_blank"
              >
                <TYPE.white fontSize={14}>Read more about MarsSwap governance</TYPE.white>
              </ExternalLink>
            </AutoColumn>
          </CardSection>
          <CardBGImage />
      ...
      <TYPE.subHeader color="text3">
        A minimum threshhold of 1% of the total Mars supply is required to submit proposals
      </TYPE.subHeader>
    </PageWrapper>
  )
}
