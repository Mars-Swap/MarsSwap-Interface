...
import { useCretStakingInfo, useStakingTime } from '../../state/stake/hooks'
...
export default function CretManage({
  match: {
    params: { currencyIdA }
  }
  ...
  const currencyA = CRET
  const stakingInfo = useCretStakingInfo()?.[0]
    ...
    <PageWrapper gap="lg" justify="center">
      ...
      <PositionInfo gap="lg" justify="center" dim={false}>
        <BottomSection gap="lg" justify="center">
          <StyledDataCard bgColor={backgroundColor} showBackground={true}>
            <CardSection>
              <CardBGImage desaturate />
              <CardNoise />
              <AutoColumn gap="md">
                <RowBetween>
                  <TYPE.white fontWeight={600}>{t('Staking Amount')}</TYPE.white>
                </RowBetween>
        ...
        <TYPE.main style={{ textAlign: 'center' }} fontSize={14}>
          ...
          {t('When you withdraw, the contract will automagically claim Mars on your behalf!', {
        ...
        <DataRow style={{ marginBottom: '1rem' }}>
          ...
          {stakingInfo?.stakedAmount?.greaterThan(JSBI.BigInt(0)) && isStakingEnd && (
            <>
