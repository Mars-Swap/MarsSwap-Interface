  ...
  return (
    <Wrapper showBackground={isStaking} bgColor={backgroundColor}>
      ...
      <RowSection>
        ...
        <StyledInternalLink
          to={`/Mars/${currencyId(currency0)}/${currencyId(currency1)}/${stakingInfo.stakingRewardAddress}`}
          style={{ width: '30%' }}
        >
        ...
        <RowBetween>
          ...
          <TYPE.white>
            {valueOfTotalStakedAmountInUSDC
              ...
              : `${valueOfTotalStakedAmountInWETH?.toSignificant(4, { groupSeparator: ',' }) ?? '-'} Mars`}
          </TYPE.white>
        </RowBetween>
        <RowBetween>
            ...
            {stakingInfo
              ? stakingInfo.active
                ? `${stakingInfo.totalRewardRate
                    ...
                    ?.toFixed(0, { groupSeparator: ',' })} Mars / week`
                : '0 Mars / week'
              : '-'}
          </TYPE.white>
        </RowBetween>
              ...
              {stakingInfo
                ? stakingInfo.active
                  ? `${stakingInfo.rewardRate
                      ?.multiply(BIG_INT_SECONDS_IN_WEEK)
                      ?.toSignificant(4, { groupSeparator: ',' })} Mars / week`
                  : '0 Mars / week'
                : '-'}
            </TYPE.black>
          </BottomSection>
